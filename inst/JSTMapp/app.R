...
samples <- inla.posterior.sample(5000, joint.inla())
if (input$model=="Spatial" | input$model=="Temporal") {
betas <- sapply(1:5000, function(x) (samples[[x]]$hyperpar)[4:5])
} else if (input$model=="Spatial + Temporal") {
betas <- sapply(1:5000, function(x) (samples[[x]]$hyperpar)[7:10])
} else if (input$model=="Spatiotemporal") {
betas <- sapply(1:5000, function(x) (samples[[x]]$hyperpar)[10:15])
}
